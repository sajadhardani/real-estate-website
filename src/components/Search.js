...
const Search = () => {
  ...
  return (
    ...
    flex flex-col lg:flex-row justify-between gap-4 lg:gap-x-3 relative lg:-top-4 lg:shadow-1 backdrop-blur-[2px] lg:bg-transparent lg:backdrop-blur rounded-md '>
        <CityDropDown />
        <PropertyDropDown />
        <PriceDropDown />
